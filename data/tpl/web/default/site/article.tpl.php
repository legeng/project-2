...
<form class="form-horizontal form" action="" method="post" enctype="multipart/form-data">
	<div class="panel panel-default">
		...
		<div class="panel-body">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-4 col-md-3 col-lg-2 control-label">初始浏览量</label>
					<div class="col-sm-8 col-xs-12">
						<input type="number" class="form-control" id="scan_count" name="scan_count" value="<?php  echo $item['scan_count'];?>">
					</div>
				</div>
		</div>
	</div>
