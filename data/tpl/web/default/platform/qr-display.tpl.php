		...
		<div class="panel-body">
			...
			<input type="hidden" name="do" value="display">
				...
				<div class="form-group">
					...
					<div class="col-sm-6 col-lg-8 col-xs-12">
						<input type="text" name="keyword" value="<?php  echo $_GPC['keyword'];?>" class="form-control" placeholder="请输入场景关键字">
					</div>
				</div>
				<div class="form-group">
		...
		<div class="table-responsive panel-body">
			<table class="table table-hover">
				...
				<tbody>
					...
					<tr>
						<td><a href="#" title="<?php  echo $row['openid'];?>"><?php  echo cutstr($row['openid'], 15)?></a></td>
