...
<div class="home">
	<div class="head clearfix">
		<div class="container">
                    <a href="http://weixinsyt.com" title="微信生意通首页"><div class="head_logo" <?php  if(!empty($_W['setting']['copyright']['flogo'])) { ?>style="background:url('<?php  echo tomedia($_W['setting']['copyright']['flogo']);?>') no-repeat;"<?php  } ?>></div></a>
		...
		<div class="con container">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
							<div class="icon"><img src="resource/images/module/01.png" alt="微现场" title="微现场"></div>
							<h6>微现场</h6>
							<p>微信上墙,现场抽奖,摇一摇抽奖活动.</p>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
							<div class="icon"><img src="resource/images/module/02.png" alt="" title=""></div>
							<h6>微旅游</h6>
							<p>旅游产品也可以在微信上实现预订了.</p>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
							<div class="icon"><img src="resource/images/module/03.png" alt="" title=""></div>
							<h6>微外卖</h6>
							<p>微外卖结合GPRS无线打印机,订单实时打印,真正做到了省时,省心,省力.</p>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
							<div class="icon"><img src="resource/images/module/04.png" alt="" title=""></div>
							<h6>微商城</h6>
							<p>每个公众号都可以建立品牌微信商城,小微信也有大商城,电商轻松走入微信.</p>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
							<div class="icon"><img src="resource/images/module/05.png" alt="" title=""></div>
							<h6>微汽车</h6>
