...
<div class="clearfix">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<input type="text" name="name" value="<?php  echo $account['name'];?>" class="form-control" autocomplete="off" placeholder="如：公司微信号" >
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<textarea style="height: 80px;" class="form-control" name="description" placeholder="如：该公众号主要用于......" ><?php  echo $account['description'];?></textarea>
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
                                            <?php  echo tpl_form_field_district('dis', array('province' => '贵州省', 'city' => '遵义市', 'district' => '' ))?>
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<textarea style="height: 80px;" class="form-control" name="wxrenzheng" placeholder="如：来自腾讯微博认证资料......"><?php  echo $account['description'];?></textarea>
	...
	<form action="" method="post"  class="form-horizontal" role="form" id="form2">
		...
		<input type="hidden" name="industry_parent" value="<?php  echo $industry_parent;?>">
		<input type="hidden" name="industry_child" value="<?php  echo $industry_child;?>">
		<input type="hidden" name="wxrenzheng" value="<?php  echo $wxrenzheng;?>">
	</form>
	<form action="" method="post"  class="form-horizontal" role="form" enctype="multipart/form-data" id="form1">
		<input type="hidden" name="step" value="3">
		<input type="hidden" name="uniacid" value="<?php  echo $uniacid;?>">
