	...
	<table class="table table-hover">
		...
		<thead class="navbar-inner">
			<tr>
				...
				<th>邮箱</th>
				<?php  if(is_array($creditnames['creditnames'])) { foreach($creditnames['creditnames'] as $creditname) { ?>
		...
		<thead>
			<tr>
				...
				<?php  if(is_array($creditnames['creditnames'])) { foreach($creditnames['creditnames'] as $index=>$creditname) { ?>
