		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-8 col-xs-12">
						<input type="text" id="" name="phone" value="<?php  if(!empty($item['phone'])) { ?><?php  echo $item['phone'];?><?php  } ?>"  class="form-control" />
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">QQ</label>
					<div class="col-sm-8 col-xs-12">
						<input type="text" id="" name="qq" value="<?php  if(!empty($item['qq'])) { ?><?php  echo $item['qq'];?><?php  } ?>"  class="form-control" />
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-8 col-xs-12" style="margin-left:-15px;">
						<?php  if(!empty($item)) { ?>
