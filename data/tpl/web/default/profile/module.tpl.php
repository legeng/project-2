			...
			<li style="width:262px;" class="list-unstyled">
				<div class="thumbnail">
					<div class="module-pic">
						<img <?php  if(file_exists('../framework/builtin/'. strtolower($row['name']).'/preview.jpg')) { ?>src="../framework/builtin/<?php  echo strtolower($row['name']);?>/preview.jpg"<?php  } else { ?>src="../addons/<?php  echo strtolower($row['name']);?>/preview.jpg"<?php  } ?> onerror="this.src='../web/resource/images/nopic.jpg'" <?php  if(!$row['enabled']) { ?>class="gray"<?php  } ?>>
