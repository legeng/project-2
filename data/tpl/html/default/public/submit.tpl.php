    ...
    <div class="iiin-box">
        <div class="iasil" style="width:1020px;">
            <div class="iucon">
                <div class="content">
                    <div class="somim">
                        <div class="concom" style="text-align:center;"><img src="./resource/images/sl07.jpg" width="900" height="246" alt="微信公众号提交" title="微信公众号提交"/></div>
                        <div class="concom">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php  echo tpl_form_field_industry('industry', '', '')?>
                                                <span class="help-block">用于说明此公众号的所属行业，选择好行业才能更好被搜索到。</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                        ...
                        <div class="content">
                            <div class="concom">
                                <p>1、微信生意通最新推出的微信公众号付费推广服务，尽在首页位置推送，详情点击&nbsp;&nbsp;<a href="<?php  echo url('public/advert');?>" target="_blank" title="微信付费推广服务" style="background:#82B440;">微信付费推广服务</a></p>
                                <p>2、如果您有自己的网站或者博客，可以与微信生意通互换链接，即可获得微信生意通首页推荐位置。</p>
                                <p>3、微信生意通合作（非客服）合作QQ-3111319984 非诚勿扰。</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    <!--baidu button begin-->
     ...
     <script type="text/javascript">
         ...
         </script><script src="./resource/js/scrolltopcontrol.js"></script>
