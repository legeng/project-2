...
if (!empty($subaccount)) {
	foreach ($subaccount as $account) {
		@unlink(IA_ROOT . '/attachment/'.$account['acid'].'/qrcode_'.$account['acid'].'.jpg');
		@unlink(IA_ROOT . '/attachment/'.$account['acid'].'/headimg_'.$account['acid'].'.jpg');
		rmdirs(IA_ROOT . '/attachment/'.$account['acid']);
	}
