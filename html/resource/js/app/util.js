...
'</div>';
		...
		var modalobj = module.dialog('请上传图片: 小于10M', content, footer, {containerName: 'image-container'}); 
		...
		defaultOptions = {
			...
			chunked: false,
			fileNumLimit: 1,
			fileSizeLimit: 1 * 1024 * 1024 * 10,
			fileSingleSizeLimit: 1 * 1024 * 1024 * 10
		};
