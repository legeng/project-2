...
function url($segment, $params = array(), $noredirect = true) {
	return _murl($segment, $params, $noredirect);
}
/*********************leegen add ***********************/
function _murl($segment, $params = array(), $noredirect = true) {
...
//leegen add
//获取两个经纬度之间的距离
//用法getDistances(27.603649,106.904162, 27.603270,106.903604);
function rad($d) { return $d * 3.1415926535898 / 180.0; }
